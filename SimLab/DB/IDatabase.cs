...
internal interface IDatabase {
    ...
    bool LoadWorldDefinition(string worldUid, out int worldId, out WorldCfg? worldCfg, 
                             out long? lastCycle, out long nextCellId, out long? lastViewedFrame, out string? error);
    ...
    bool SaveGlobalInitials(int worldId, World world, out string? error);
    bool LoadGlobalInitials(int worldId, World world, out string? error);
}
